// elm-watch hot {"version":"2.0.0-beta.7","targetName":"My target name","webSocketConnection":52683,"webSocketToken":"4f832013-9dcc-4cd2-a3e7-17609082a41a"}
"use strict";
(() => {
...
${indent.repeat(level)}}`;
  ...
  var WEBSOCKET_TOKEN = "4f832013-9dcc-4cd2-a3e7-17609082a41a";
  ...
  var WEBSOCKET_CONNECTION = "52683";
...
var $author$project$Main$Dog = F4(
	function (name, age, breed, image) {
		return {age: age, breed: breed, image: image, name: name};
	});
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $author$project$Main$Beagle = {$: 'Beagle'};
var $author$project$Main$Poodle = {$: 'Poodle'};
var $author$project$Main$Sheltie = {$: 'Sheltie'};
var $elm$core$Debug$log = _Debug_log;
var $elm$core$String$toLower = _String_toLower;
var $elm$core$Debug$todo = _Debug_todo;
var $author$project$Main$decodeBreed = function (breed) {
	var _v0 = $elm$core$String$toLower(
		A2($elm$core$Debug$log, 'breed', breed));
	switch (_v0) {
		case 'sheltie':
			return $elm$json$Json$Decode$succeed($author$project$Main$Sheltie);
		case 'poodle':
			return $elm$json$Json$Decode$succeed($author$project$Main$Poodle);
		case 'beagle':
			return $elm$json$Json$Decode$succeed($author$project$Main$Beagle);
		default:
			return _Debug_todo(
				'Main',
				{
...
var $author$project$Main$decodeDog = A3(
	...
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'breed',
		A2($elm$json$Json$Decode$andThen, $author$project$Main$decodeBreed, $elm$json$Json$Decode$string),
		A3(
			$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'age',
			...
			A3(
				...
				'name',
				$elm$json$Json$Decode$string,
				$elm$json$Json$Decode$succeed($author$project$Main$Dog)))));
var $elm$json$Json$Decode$decodeString = _Json_runOnString;
var $author$project$Main$jsonDog = '\n    {\n        "name": "Tucker",\n        "age": 11,\n        "breed": "Poodle",\n        "image": "/poodle.jpg"\n    }\n    ';
var $author$project$Main$decodedDog = A2($elm$json$Json$Decode$decodeString, $author$project$Main$decodeDog, $author$project$Main$jsonDog);
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$Main$breedToString = function (breed) {
	switch (breed.$) {
		case 'Sheltie':
			return 'Sheltie';
		case 'Poodle':
...
var $author$project$Main$viewDog = function (dog) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src(dog.image)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$p,
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						dog.name + (' the ' + ($author$project$Main$breedToString(dog.breed) + (' is ' + ($elm$core$String$fromInt(dog.age) + ' years old.')))))
					]))
			]));
};
var $author$project$Main$main = function () {
	var _v0 = A2($elm$core$Debug$log, 'decodedDog', $author$project$Main$decodedDog);
	if (_v0.$ === 'Ok') {
		var dog = _v0.a;
		return $author$project$Main$viewDog(dog);
	} else {
		return $elm$html$Html$text('ERROR: Couldn\'t decode dog.');
	}
}();
