// elm-watch hot {"version":"2.0.0-beta.7","targetName":"My target name","webSocketConnection":55557,"webSocketToken":"45daee25-5366-4b2f-b4ea-b71f7ad43f52"}
"use strict";
(() => {
...
${indent.repeat(level)}}`;
  ...
  var WEBSOCKET_TOKEN = "45daee25-5366-4b2f-b4ea-b71f7ad43f52";
  ...
  var WEBSOCKET_CONNECTION = "55557";
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{description: '', hover: false, images: _List_Nil, title: ''},
		$elm$core$Platform$Cmd$none);
};
			...
			case 'GotFiles':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							hover: false,
							images: A2($elm$core$List$cons, file, files)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
...
var $author$project$Main$DragEnter = {$: 'DragEnter'};
var $author$project$Main$DragLeave = {$: 'DragLeave'};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$name('text'),
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$placeholder('Write a description for your images'),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2('hover', model.hover)
							])),
						A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Drop files here from your file system.')
					]))
			]));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"UpdateTitle":["String.String"],"UpdateDescription":["String.String"],"Pick":[],"DragEnter":[],"DragLeave":[],"GotFiles":["File.File","List.List File.File"],"Submit":[]}},"File.File":{"args":[],"tags":{"File":[]}},"List.List":{"args":["a"],"tags":{}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));