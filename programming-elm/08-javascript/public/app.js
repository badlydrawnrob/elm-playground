(() => {
    ...
    "node_modules/react/cjs/react.development.js"(exports, module) {
      ...
      if (true) {
        (function() {
          ...
          var REACT_PLACEHOLDER_TYPE = hasSymbol ? Symbol.for("react.placeholder") : 60113;
          ...
          function forwardRef(render2) {
            {
              if (typeof render2 !== "function") {
                warningWithoutStack$1(false, "forwardRef requires a render function but was given %s.", render2 === null ? "null" : typeof render2);
              } else {
                !// Do not warn for 0 arguments because it could be due to usage of the 'arguments' object
                (render2.length === 0 || render2.length === 2) ? warningWithoutStack$1(false, "forwardRef render functions accept exactly two parameters: props and ref. %s", render2.length === 1 ? "Did you forget to use the ref parameter?" : "Any additional parameter will be undefined.") : void 0;
              }
              if (render2 != null) {
                !(render2.defaultProps == null && render2.propTypes == null) ? warningWithoutStack$1(false, "forwardRef render functions do not support propTypes or defaultProps. Did you accidentally pass a React component?") : void 0;
              }
            }
            return {
          ...
          if (enableSuspense) {
            React3.Placeholder = REACT_PLACEHOLDER_TYPE;
            React3.lazy = lazy;
          }
          var React$2 = Object.freeze({
            default: React3
          });
          var React$3 = React$2 && React3 || React$2;
  ...
  var require_schedule_development = __commonJS({
    "node_modules/schedule/cjs/schedule.development.js"(exports) {
      "use strict";
      if (true) {
        (function() {
          "use strict";
          Object.defineProperty(exports, "__esModule", { value: true });
          var DEFERRED_TIMEOUT = 5e3;
          ...
          function unstable_scheduleWork(callback, options) {
            var currentTime = exports.unstable_now();
            var timesOutAt;
            if (options !== void 0 && options !== null && options.timeout !== null && options.timeout !== void 0) {
  ...
  var require_schedule = __commonJS({
    "node_modules/schedule/index.js"(exports, module) {
      "use strict";
      if (false) {
        module.exports = null;
      } else {
        module.exports = require_schedule_development();
      }
    }
  });

  // node_modules/schedule/cjs/schedule-tracing.development.js
  var require_schedule_tracing_development = __commonJS({
    "node_modules/schedule/cjs/schedule-tracing.development.js"(exports) {
      "use strict";
      if (true) {
        (function() {
          "use strict";
  ...
  var require_tracing = __commonJS({
    "node_modules/schedule/tracing.js"(exports, module) {
      "use strict";
      if (false) {
        module.exports = null;
      } else {
        module.exports = require_schedule_tracing_development();
      }
    }
  });
    ...
    "node_modules/react-dom/cjs/react-dom.development.js"(exports, module) {
      ...
      if (true) {
        (function() {
          ...
          !React3 ? invariant(false, "ReactDOM was loaded before React. Make sure you load the React package before loading ReactDOM.") : void 0;
          ...
          function trapBubbledEvent(topLevelType, element) {
            ...
            var dispatch2 = isInteractiveTopLevelEventType(topLevelType) ? dispatchInteractiveEvent : dispatchEvent;
            addEventBubbleListener(
              element,
              getRawEventName(topLevelType),
              // Check if interactive and wrap in interactiveUpdates
              dispatch2.bind(null, topLevelType)
            );
          }
          ...
          function resolveLazyComponentTag(fiber, Component2) {
            if (typeof Component2 === "function") {
              return shouldConstruct(Component2) ? ClassComponentLazy : FunctionalComponentLazy;
            } else if (Component2 !== void 0 && Component2 !== null && Component2.$$typeof) {
          ...
          function createWorkInProgress(current2, pendingProps, expirationTime) {
            ...
            if (pendingProps !== current2.pendingProps) {
          ...
          function constructClassInstance(workInProgress, ctor, props, renderExpirationTime) {
            ...
            var isContextConsumer = contextTypes !== null && contextTypes !== void 0;
          ...
          function updateClassInstance(current2, workInProgress, ctor, newProps, renderExpirationTime) {
            var instance = workInProgress.stateNode;
            var oldProps = workInProgress.memoizedProps;
            instance.props = oldProps;
            var oldContext = instance.context;
              ...
              if (typeof newChild === "undefined" && !isUnkeyedTopLevelFragment) {
                switch (returnFiber.tag) {
                  ...
                  case FunctionalComponent: {
                    ...
                    invariant(false, "%s(...): Nothing was returned from render. This usually means a return statement is missing. Or, to render nothing, return null.", Component2.displayName || Component2.name || "Component");
                  }
                }
              }
          ...
          function readLazyComponentType(thenable) {
            ...
            switch (status) {
              case Resolved:
                var Component2 = thenable._reactResult;
                return Component2;
              case Rejected:
                ...
                thenable.then(function(resolvedValue) {
                  if (thenable._reactStatus === Pending) {
                    ...
                    if (typeof resolvedValue === "object" && resolvedValue !== null) {
                      ...
                      resolvedValue = defaultExport !== void 0 && defaultExport !== null ? defaultExport : resolvedValue;
                    } else {
          ...
          function updateFunctionalComponent(current$$1, workInProgress, Component2, nextProps, renderExpirationTime) {
            var unmaskedContext = getUnmaskedContext(workInProgress, Component2, true);
            ...
            prepareToReadContext(workInProgress, renderExpirationTime);
            {
              ReactCurrentOwner$3.current = workInProgress;
              setCurrentPhase("render");
              nextChildren = Component2(nextProps, context);
              setCurrentPhase(null);
            }
          ...
          function updateClassComponent(current$$1, workInProgress, Component2, nextProps, renderExpirationTime) {
            ...
            if (current$$1 === null) {
              if (workInProgress.stateNode === null) {
                constructClassInstance(workInProgress, Component2, nextProps, renderExpirationTime);
                mountClassInstance(workInProgress, Component2, nextProps, renderExpirationTime);
                shouldUpdate = true;
              } else {
                shouldUpdate = resumeMountClassInstance(workInProgress, Component2, nextProps, renderExpirationTime);
              }
            } else {
              shouldUpdate = updateClassInstance(current$$1, workInProgress, Component2, nextProps, renderExpirationTime);
            }
            return finishClassComponent(current$$1, workInProgress, Component2, shouldUpdate, hasContext, renderExpirationTime);
          }
          function finishClassComponent(current$$1, workInProgress, Component2, shouldUpdate, hasContext, renderExpirationTime) {
            markRef(current$$1, workInProgress);
            var didCaptureError = (workInProgress.effectTag & DidCapture) !== NoEffect;
            if (!shouldUpdate && !didCaptureError) {
              if (hasContext) {
                invalidateContextProvider(workInProgress, Component2, false);
              }
              return bailoutOnAlreadyFinishedWork(current$$1, workInProgress, renderExpirationTime);
            }
            var instance = workInProgress.stateNode;
            ReactCurrentOwner$3.current = workInProgress;
            var nextChildren = void 0;
            if (didCaptureError && (!enableGetDerivedStateFromCatch || typeof Component2.getDerivedStateFromCatch !== "function")) {
              nextChildren = null;
              if (enableProfilerTimer) {
            ...
            if (hasContext) {
              invalidateContextProvider(workInProgress, Component2, true);
            }
            return workInProgress.child;
          }
          ...
          function mountIndeterminateComponent(current$$1, workInProgress, Component2, renderExpirationTime) {
            ...
            if (typeof Component2 === "object" && Component2 !== null && typeof Component2.then === "function") {
              Component2 = readLazyComponentType(Component2);
              var resolvedTag = workInProgress.tag = resolveLazyComponentTag(workInProgress, Component2);
              var resolvedProps = resolveDefaultProps(Component2, props);
              switch (resolvedTag) {
                case FunctionalComponentLazy: {
                  return updateFunctionalComponent(current$$1, workInProgress, Component2, resolvedProps, renderExpirationTime);
                }
                case ClassComponentLazy: {
                  return updateClassComponent(current$$1, workInProgress, Component2, resolvedProps, renderExpirationTime);
                }
                case ForwardRefLazy: {
                  return updateForwardRef(current$$1, workInProgress, Component2, resolvedProps, renderExpirationTime);
                }
                default: {
                  invariant(false, "Element type is invalid. Received a promise that resolves to: %s. Promise elements must resolve to a class or function.", Component2);
                }
              }
            }
            var unmaskedContext = getUnmaskedContext(workInProgress, Component2, false);
            var context = getMaskedContext(workInProgress, unmaskedContext);
            prepareToReadContext(workInProgress, renderExpirationTime);
            var value = void 0;
            {
              ...
              ReactCurrentOwner$3.current = workInProgress;
              value = Component2(props, context);
            }
            workInProgress.effectTag |= PerformedWork;
            if (typeof value === "object" && value !== null && typeof value.render === "function" && value.$$typeof === void 0) {
              ...
              if (typeof getDerivedStateFromProps === "function") {
                applyDerivedStateFromProps(workInProgress, Component2, getDerivedStateFromProps, props);
              }
              adoptClassInstance(workInProgress, value);
              mountClassInstance(workInProgress, Component2, props, renderExpirationTime);
              return finishClassComponent(current$$1, workInProgress, Component2, true, hasContext, renderExpirationTime);
            } else {
              workInProgress.tag = FunctionalComponent;
              {
                if (Component2) {
                  !!Component2.childContextTypes ? warningWithoutStack$1(false, "%s(...): childContextTypes cannot be defined on a functional component.", Component2.displayName || Component2.name || "Component") : void 0;
                }
            ...
            if (!hasContextChanged() && (updateExpirationTime === NoWork || updateExpirationTime > renderExpirationTime)) {
              switch (workInProgress.tag) {
                ...
                case HostComponent:
                  ...
                  break;
                case ClassComponent: {
                  var Component2 = workInProgress.type;
                  if (isContextProvider(Component2)) {
                    pushContextProvider(workInProgress);
                  }
                  break;
          ...
          function completeWork(current2, workInProgress, renderExpirationTime) {
            var newProps = workInProgress.pendingProps;
            switch (workInProgress.tag) {
              case FunctionalComponent:
              case FunctionalComponentLazy:
          ...
          function throwException(root2, returnFiber, sourceFiber, value, renderExpirationTime) {
            ...
            if (enableSuspense && value !== null && typeof value === "object" && typeof value.then === "function") {
              ...
              do {
                if (_workInProgress.tag === PlaceholderComponent) {
                  var current2 = _workInProgress.alternate;
                  if (current2 !== null && current2.memoizedState === true && current2.stateNode !== null) {
                    var timedOutAt = current2.stateNode.timedOutAt;
              ...
              do {
                if (_workInProgress.tag === PlaceholderComponent) {
                  ...
                  if (!didTimeout) {
                    ...
                    var onResolveOrReject = retrySuspendedRoot.bind(null, root2, _workInProgress, pingTime);
                    ...
                    if (earliestTimeoutMs === -1) {
                      ...
                      if (startTimeMs === -1) {
                        var earliestExpirationTime = findEarliestOutstandingPriorityLevel(root2, renderExpirationTime);
                        var earliestExpirationTimeMs = expirationTimeToMs(earliestExpirationTime);
                        startTimeMs = earliestExpirationTimeMs - LOW_PRIORITY_EXPIRATION;
                      }
                      absoluteTimeoutMs = startTimeMs + earliestTimeoutMs;
                    }
                    renderDidSuspend(root2, absoluteTimeoutMs, renderExpirationTime);
          ...
          function unwindInterruptedWork(interruptedWork) {
            switch (interruptedWork.tag) {
              ...
              case ClassComponentLazy: {
                ...
                if (_childContextTypes !== null && _childContextTypes !== void 0) {
                  popContext(interruptedWork);
                }
                break;
              }
            ...
            replayUnitOfWork = function(failedUnitOfWork, thrownValue, isYieldy) {
              ...
              switch (failedUnitOfWork.tag) {
                ...
                case HostComponent:
                  ...
                  break;
                case ClassComponent: {
                  var Component2 = failedUnitOfWork.type;
                  if (isContextProvider(Component2)) {
            ...
            if (enableSchedulerTracing) {
              ...
              root2.pendingInteractionMap.forEach(function(scheduledInteractions, scheduledExpirationTime) {
                if (scheduledExpirationTime <= committedExpirationTime) {
                  ...
                  root2.pendingInteractionMap.delete(scheduledExpirationTime);
                }
              });
            }
          ...
          function renderRoot(root2, isYieldy, isExpired) {
          ...
          function retrySuspendedRoot(root2, fiber, suspendedTime) {
            if (enableSuspense) {
              ...
              if (rootExpirationTime !== NoWork) {
                if (enableSchedulerTracing) {
                  ...
                  tracing.__interactionsRef.current = root2.memoizedInteractions;
                  storeInteractionsForExpirationTime(root2, rootExpirationTime, false);
          ...
          function storeInteractionsForExpirationTime(root2, expirationTime, updateInteractionCounts) {
            if (!enableSchedulerTracing) {
              return;
            }
            var interactions = tracing.__interactionsRef.current;
            if (interactions.size > 0) {
              var pendingInteractions = root2.pendingInteractionMap.get(expirationTime);
              if (pendingInteractions != null) {
                ...
                root2.pendingInteractionMap.set(expirationTime, new Set(interactions));
          ...
          function scheduleWork(fiber, expirationTime) {
            ...
            if (enableSchedulerTracing) {
              storeInteractionsForExpirationTime(root2, expirationTime, true);
            }
          ...
          function scheduleCallbackWithExpirationTime(root2, expirationTime) {
            ...
            callbackID = schedule.unstable_scheduleWork(performAsyncWork, { timeout });
          }
          ...
          function requestWork(root2, expirationTime) {
            ...
            if (isBatchingUpdates) {
              if (isUnbatchingUpdates) {
                ...
                performWorkOnRoot(root2, Sync, true);
              }
              return;
            }
          ...
          function addRootToSchedule(root2, expirationTime) {
            if (root2.nextScheduledRoot === null) {
              ...
              var remainingExpirationTime = root2.expirationTime;
          ...
          function flushRoot(root2, expirationTime) {
            ...
            performWorkOnRoot(root2, expirationTime, true);
            performSyncWork();
          }
          ...
          function performWorkOnRoot(root2, expirationTime, isExpired) {
            ...
            if (deadline === null || isExpired) {
              ...
              if (finishedWork !== null) {
                ...
                var isYieldy = false;
                renderRoot(root2, isYieldy, isExpired);
              ...
              if (_finishedWork !== null) {
                ...
                var _isYieldy = true;
                renderRoot(root2, _isYieldy, isExpired);
          ...
          function ReactRoot(container, isAsync, hydrate) {
            var root2 = createContainer(container, isAsync, hydrate);
          ...
          ReactDOM2.unstable_createRoot = function createRoot(container, options) {
  ...
  var App = class extends import_react.Component {
    constructor(props) {
      super(props);
      this.state = {
    ...
    render() {
      ...
      return /* @__PURE__ */ import_react.default.createElement("div", { className: "note" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "note__info" }, /* @__PURE__ */ import_react.default.createElement("h2", null, "Info"), /* @__PURE__ */ import_react.default.createElement("div", { className: "note__title" }, /* @__PURE__ */ import_react.default.createElement("label", null, "Title:"), /* @__PURE__ */ import_react.default.createElement(
        "input",
        {
          type: "text",
          value: note.title,
      ...
      )), /* @__PURE__ */ import_react.default.createElement("div", { className: "note__contents" }, /* @__PURE__ */ import_react.default.createElement("label", null, "Contents:"), /* @__PURE__ */ import_react.default.createElement(
        "textarea",
        {
          value: note.contents,
  ...
  function render() {
    ...
    import_react_dom.default.render(/* @__PURE__ */ import_react2.default.createElement(App_default, null), root);
  }
  render();
})();
...
schedule/cjs/schedule.development.js:
  (** @license React v16.5.2
...
schedule/cjs/schedule-tracing.development.js:
  (** @license React v16.5.2
