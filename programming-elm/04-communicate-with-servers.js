...
var $author$project$Communicate$WithServers$LoadFeed = function (a) {
	return {$: 'LoadFeed', a: a};
};
var $author$project$Communicate$WithServers$baseUrl = 'https://programming-elm.com/';
...
var $author$project$Communicate$WithServers$Photo = F6(
...
var $author$project$Communicate$WithServers$photoDecoder = A2(
			...
			A3(
				...
				A3(
					...
					A3(
						...
						$elm$json$Json$Decode$succeed($author$project$Communicate$WithServers$Photo)))))));
var $author$project$Communicate$WithServers$fetchFeed = $elm$http$Http$get(
	{
...
var $author$project$Communicate$WithServers$subscriptions = function (model) {
...
var $author$project$Communicate$WithServers$SaveComment = {$: 'SaveComment'};
var $author$project$Communicate$WithServers$UpdateComment = function (a) {
...
var $author$project$Communicate$WithServers$viewComment = function (comment) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Communicate$WithServers$viewCommentList = function (comments) {
	if (!comments.b) {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$ul,
					_List_Nil,
					A2($elm$core$List$map, $author$project$Communicate$WithServers$viewComment, comments))
				]));
	}
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onSubmit($author$project$Communicate$WithServers$SaveComment)
					]),
				_List_fromArray(
					[
						A2(
...
var $author$project$Communicate$WithServers$main = $elm$browser$Browser$element(
	{init: $author$project$Communicate$WithServers$init, subscriptions: $author$project$Communicate$WithServers$subscriptions, update: $author$project$Communicate$WithServers$update, view: $author$project$Communicate$WithServers$view});
_Platform_export({'Communicate':{'WithServers':{'init':$author$project$Communicate$WithServers$main(
