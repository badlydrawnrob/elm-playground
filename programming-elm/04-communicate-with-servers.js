		...
		switch (msg.$) {
			...
			case 'UpdateComment':
				...
				return _Utils_update(
					...
					{newComment: comment});
			default:
				return $author$project$Communicate$WithServers$saveNewComment(model);
		}
	});
...
var $author$project$Communicate$WithServers$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Communicate$WithServers$initialModel, update: $author$project$Communicate$WithServers$update, view: $author$project$Communicate$WithServers$view});
