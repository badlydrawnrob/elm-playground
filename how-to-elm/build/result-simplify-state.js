...
var $author$project$Result$SimplifyState$initialModel = {errors: _List_Nil, mins: '', secs: ''};
...
var $author$project$Result$SimplifyState$viewError = function (err) {
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
...
var $author$project$Result$SimplifyState$view = function (model) {
	return A2(
		$elm$html$Html$form,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('float-input'),
				$elm$html$Html$Events$onSubmit($author$project$Result$SimplifyState$SaveInput)
			]),
		_List_fromArray(
			[
				A2(
				...
				$elm$html$Html$div,
				_List_Nil,
				A2($elm$core$List$map, $author$project$Result$SimplifyState$viewError, model.errors))
			]));
};
