...
var $author$project$Form$SingleField$initialModel = {currentEntry: '', entries: _List_Nil, id: 0};
				...
				return _Utils_update(
					model,
					{
						...
						entries: _Utils_ap(
							...
							_List_fromArray(
								[
									A2($author$project$Form$SingleField$Entry, model.id, entry)
								])),
						id: model.id + 1
					});
			}
...
var $author$project$Form$SingleField$viewEntryItem = function (_v0) {
	var id = _v0.id;
	var text = _v0.text;
	return A2(
		$elm$html$Html$li,
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$core$String$isEmpty(currentEntry))
					]),
				_List_fromArray(
					[
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$core$List$map, $author$project$Form$SingleField$viewEntryItem, entries)),
					$author$project$Form$SingleField$viewForm(model.currentEntry)
				]));
	}
};
