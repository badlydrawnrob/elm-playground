// elm-watch hot {"version":"2.0.0-beta.9","targetName":"My target name","webSocketConnection":50439,"webSocketToken":"c7bb07b9-682e-4ce9-a492-7c16a6e9e63d"}
"use strict";
(() => {
...
${indent.repeat(level)}}`;
  ...
  var WEBSOCKET_TOKEN = "c7bb07b9-682e-4ce9-a492-7c16a6e9e63d";
  ...
  var WEBSOCKET_CONNECTION = "50439";
...
var $author$project$File$CSV$Model = function (csv) {
	return {csv: csv};
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$File$CSV$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$File$CSV$Model($elm$core$Maybe$Nothing),
		$elm$core$Platform$Cmd$none);
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$File$CSV$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$File$CSV$CsvLoaded = function (a) {
	return {$: 'CsvLoaded', a: a};
};
var $author$project$File$CSV$CsvSelected = function (a) {
...
var $author$project$File$CSV$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'CsvRequested':
				return _Utils_Tuple2(
					...
					A2(
						...
						_List_fromArray(
							['text/csv']),
						$author$project$File$CSV$CsvSelected));
			case 'CsvSelected':
				var file = msg.a;
				return _Utils_Tuple2(
					model,
					A2(
						$elm$core$Task$perform,
						$author$project$File$CSV$CsvLoaded,
...
var $author$project$File$CSV$CsvRequested = {$: 'CsvRequested'};
...
var $author$project$File$CSV$view = function (model) {
	var _v0 = model.csv;
	if (_v0.$ === 'Nothing') {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Events$onClick($author$project$File$CSV$CsvRequested)
				]),
			_List_fromArray(
				[
...
var $author$project$File$CSV$main = $elm$browser$Browser$element(
	{init: $author$project$File$CSV$init, subscriptions: $author$project$File$CSV$subscriptions, update: $author$project$File$CSV$update, view: $author$project$File$CSV$view});
_Platform_export({'File':{'CSV':{'init':$author$project$File$CSV$main(
