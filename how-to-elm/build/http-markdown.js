...
var $author$project$Http$Markdown$customOptions = {
	rawHtml: $pablohirafuji$elm_markdown$Markdown$Config$Sanitize(
		{
			allowedHtmlAttributes: _List_fromArray(
				['class', 'id']),
			allowedHtmlElements: _List_Nil
		}),
	softAsHardLineBreak: false
};
var $elm$html$Html$div = _VirtualDom_node('div');
var $author$project$Http$Markdown$inlineCode = '`function : List Int -> Int`';
...
var $author$project$Http$Markdown$subHeader = '## Sub header {#id .class key=\"value\"}';
...
var $author$project$Http$Markdown$title = A2($pablohirafuji$elm_markdown$Markdown$Block$parse, $elm$core$Maybe$Nothing, '# Markdown code renderer');
...
var $author$project$Http$Markdown$titleBlock = A2(
	$elm$html$Html$div,
	_List_Nil,
	$elm$core$List$concat(
		A2($elm$core$List$map, $pablohirafuji$elm_markdown$Markdown$Block$toHtml, $author$project$Http$Markdown$title)));
...
var $author$project$Http$Markdown$main = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			$author$project$Http$Markdown$titleBlock,
			A2(
			$elm$html$Html$div,
			_List_Nil,
			$elm$core$List$concat(
				A2(
					...
					$pablohirafuji$elm_markdown$Markdown$toHtml(
						$elm$core$Maybe$Just($author$project$Http$Markdown$customOptions)),
					_List_fromArray(
						[$author$project$Http$Markdown$inlineCode, $author$project$Http$Markdown$subHeader, $author$project$Http$Markdown$body, $author$project$Http$Markdown$codeBlock]))))
		]));
_Platform_export({'Http':{'Markdown':{'init':_VirtualDom_init($author$project$Http$Markdown$main)(0)(0)}}});}(this));