...
var $author$project$File$ImageServer$ApiKey = function (a) {
	return {$: 'ApiKey', a: a};
};
		...
		return $elm$http$Http$request(
			{
				...
				url: A2($author$project$File$ImageForm$buildUrl, expiration, str)
			});
	});
		...
		switch (msg.$) {
			...
			case 'SendToServer':
				...
				return _Utils_Tuple2(
					model,
					A3(
						$author$project$File$ImageForm$postImage,
						'600',
						$author$project$File$ImageServer$ApiKey('104e88f54082d98be7ac1d3649ba21d1'),
						base64));
			default:
				var payload = msg.a;
				return _Utils_Tuple2(
