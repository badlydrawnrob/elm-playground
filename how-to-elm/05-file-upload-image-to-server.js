...
var $author$project$File$ImageResponse$freeImageUrl = 'https://freeimage.host/api/1/upload?key=';
		...
		return $elm$http$Http$post(
			{
				...
				url: $author$project$File$ImageResponse$freeImageUrl + (key + ('&source=' + (file + '&format=json')))
			});
	});
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('filename: ' + model.imageName)
								]))
						])),
					A2(
					$elm$html$Html$p,
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Upload Image to Server!')
						]))
				]));
	}
};
			...
			switch (error.$) {
				...
				case 'Timeout':
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Oops! There\'s been a TIMEOUT. Start again?')
							]));
				case 'NetworkError':
					return A2(
						$elm$html$Html$p,
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Oops! There\'s been a NETWORK ERROR. Start again?')
							]));
				case 'BadStatus':
					var num = error.a;
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								'Oops! There\'s been a' + ($elm$core$String$fromInt(num) + '. Start again?'))
							]));
				default:
					var str = error.a;
					return A2(
...
_Platform_export({'File':{'Image':{'init':$author$project$File$Image$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"File.ImageModel.Msg","aliases":{"File.ImageModel.Base24":{"args":[],"type":"String.String"}},"unions":{"File.ImageModel.Msg":{"args":[],"tags":{"ImageRequested":[],"ImageSelected":["File.File"],"ImageLoaded":["String.String"],"SendToServer":["File.ImageModel.Base24"],"SentImage":["Result.Result Http.Error String.String"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"File.File":{"args":[],"tags":{"File":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}}});}(this));