// elm-watch hot {"version":"1.2.2","targetName":"My target name","webSocketPort":49631,"webSocketToken":"95fb94f3-7f53-4481-9b1e-04a3d1c24aa0"}
"use strict";
(() => {
...
// added by elm-watch
var _elmWatchTargetName = "My target name";
...
var $author$project$CustomTypes$Films$Film = F2(
	function (a, b) {
		return {$: 'Film', a: a, b: b};
	});
var $author$project$CustomTypes$Films$FilmID = function (a) {
	return {$: 'FilmID', a: a};
};
var $author$project$CustomTypes$Films$Internals = F6(
	function (id, title, trailer, summary, poster, tags) {
		return {id: id, poster: poster, summary: summary, tags: tags, title: title, trailer: trailer};
	});
...
var $author$project$CustomTypes$Films$decodePoster = function (posterList) {
	return ($elm$core$List$length(posterList) === 1) ? $elm$json$Json$Decode$succeed(
		A2(
			$elm$core$Maybe$withDefault,
			'',
			$elm$core$List$head(posterList))) : $elm$json$Json$Decode$fail('Poster list must have exactly one item');
};
...
var $author$project$CustomTypes$Films$decodeFilmMeta = A7(
	...
	$author$project$CustomTypes$Films$Internals,
	A2(
		$elm$json$Json$Decode$field,
		'id',
		A2($elm$json$Json$Decode$map, $author$project$CustomTypes$Films$FilmID, $elm$json$Json$Decode$string)),
	A2($elm$json$Json$Decode$field, 'title', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
		'trailer',
		A2($elm$json$Json$Decode$map, $elm$url$Url$fromString, $elm$json$Json$Decode$string)),
	A2($elm$json$Json$Decode$field, 'summary', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$andThen,
		$author$project$CustomTypes$Films$decodePoster,
		A2(
			$elm$json$Json$Decode$field,
			'poster',
...
var $author$project$CustomTypes$Films$Review = F4(
	function (timestamp, name, review, rating) {
		return {name: name, rating: rating, review: review, timestamp: timestamp};
	});
var $author$project$CustomTypes$Films$Five = {$: 'Five'};
var $author$project$CustomTypes$Films$Four = {$: 'Four'};
var $author$project$CustomTypes$Films$One = {$: 'One'};
var $author$project$CustomTypes$Films$Three = {$: 'Three'};
var $author$project$CustomTypes$Films$Two = {$: 'Two'};
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$CustomTypes$Films$decodeStars = function () {
	var decodeNumber = function (number) {
		switch (number) {
			case 1:
				return $elm$json$Json$Decode$succeed($author$project$CustomTypes$Films$One);
			case 2:
				return $elm$json$Json$Decode$succeed($author$project$CustomTypes$Films$Two);
			case 3:
				return $elm$json$Json$Decode$succeed($author$project$CustomTypes$Films$Three);
			case 4:
				return $elm$json$Json$Decode$succeed($author$project$CustomTypes$Films$Four);
			case 5:
				return $elm$json$Json$Decode$succeed($author$project$CustomTypes$Films$Five);
			default:
				return $elm$json$Json$Decode$fail('This is not the number you\'re looking for!');
		}
	};
	return A2($elm$json$Json$Decode$andThen, decodeNumber, $elm$json$Json$Decode$int);
}();
...
var $author$project$CustomTypes$Films$decodeReview = A5(
	$elm$json$Json$Decode$map4,
	$author$project$CustomTypes$Films$Review,
	A2($elm$json$Json$Decode$field, 'timestamp', $rtfeldman$elm_iso8601_date_strings$Iso8601$decoder),
	A2(
		$elm$json$Json$Decode$field,
		'name',
		A2($elm$json$Json$Decode$map, $author$project$CustomTypes$Films$Name, $elm$json$Json$Decode$string)),
	A2($elm$json$Json$Decode$field, 'review', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'stars', $author$project$CustomTypes$Films$decodeStars));
var $author$project$CustomTypes$Films$decodeFilm = A3(
	$elm$json$Json$Decode$map2,
	$author$project$CustomTypes$Films$Film,
	$author$project$CustomTypes$Films$decodeFilmMeta,
	A2(
		$elm$json$Json$Decode$field,
		'reviews',
...
var $author$project$CustomTypes$Films$urlAPI = 'http://localhost:3000';
var $author$project$CustomTypes$Films$getFilms = $elm$http$Http$get(
	{
		expect: A2(
			$elm$http$Http$expectJson,
			$author$project$CustomTypes$Films$GotFilms,
			$elm$json$Json$Decode$list($author$project$CustomTypes$Films$decodeFilm)),
		url: $author$project$CustomTypes$Films$urlAPI + '/films'
	});
...
var $author$project$CustomTypes$Films$init = function (_v0) {
	return _Utils_Tuple2(
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					$author$project$CustomTypes$Films$getFilms,
					A2(
					$elm$core$Task$perform,
					function (_v1) {
						return $author$project$CustomTypes$Films$PassedSlowLoadingThreshold;
					},
...
var $author$project$CustomTypes$Films$LoadingSlowly = {$: 'LoadingSlowly'};
...
var $author$project$CustomTypes$Films$getReview = function (reviewID) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$CustomTypes$Films$GotReview, $author$project$CustomTypes$Films$decodeReview),
			url: $author$project$CustomTypes$Films$urlAPI + ('/reviews' + ('/' + $elm$core$String$fromInt(reviewID)))
		});
};
...
var $author$project$CustomTypes$Films$randomNumber = function () {
	var oneToTen = A2($elm$random$Random$int, 1, 10);
...
var $author$project$CustomTypes$Films$updateFilms = F2(
	function (transform, films) {
		return A2($elm$core$List$map, transform, films);
	});
var $author$project$CustomTypes$Films$addReviewToFilm = F2(
	function (review, _v0) {
		var internals = _v0.a;
		var reviews = _v0.b;
		return A2(
...
var $author$project$CustomTypes$Films$updateReviews = F3(
	function (filmID, review, film) {
		return _Utils_eq(
			filmID,
			$author$project$CustomTypes$Films$getFilmID(film)) ? A2($author$project$CustomTypes$Films$addReviewToFilm, review, film) : film;
	});
var $author$project$CustomTypes$Films$update = F2(
	function (msg, model) {
						...
						_Utils_update(
							model,
							{
								errors: _List_fromArray(
									['Cannot add review without a film'])
							}),
						$elm$core$Platform$Cmd$none);
				}
				...
				if (_v0.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								van: $author$project$CustomTypes$Films$Error(
									'Failed to load films' + $elm$core$Debug$toString(error))
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'GotNumber':
				...
				return _Utils_Tuple2(
					model,
					$author$project$CustomTypes$Films$getReview(number));
			case 'GotReview':
				if (_v0.a.$ === 'Ok') {
					var review = _v0.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								apiReview: $elm$core$Maybe$Just(review)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
			...
			case 'PassedSlowLoadingThreshold':
				...
				if (_v5.$ === 'Loading') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{van: $author$project$CustomTypes$Films$LoadingSlowly}),
						$elm$core$Platform$Cmd$none);
				} else {
...
var $author$project$CustomTypes$Films$saveFilmButton = function (caption) {
	return A2(
...
var $author$project$CustomTypes$Films$InputPoster = function (a) {
	return {$: 'InputPoster', a: a};
};
var $author$project$CustomTypes$Films$InputSummary = function (a) {
	return {$: 'InputSummary', a: a};
};
var $author$project$CustomTypes$Films$InputTags = function (a) {
	return {$: 'InputTags', a: a};
};
var $author$project$CustomTypes$Films$InputTitle = function (a) {
	return {$: 'InputTitle', a: a};
};
var $author$project$CustomTypes$Films$InputTrailer = function (a) {
	return {$: 'InputTrailer', a: a};
};
...
var $author$project$CustomTypes$Films$viewInput = F4(
	function (t, toMsg, p, v) {
		return A2(
			$elm$html$Html$input,
			_List_fromArray(
				[
...
var $author$project$CustomTypes$Films$viewFilmForm = F3(
	function (maybeFilmID, form, button) {
		return A2(
			$elm$html$Html$form,
			_List_fromArray(
				[
					$elm$html$Html$Events$onSubmit(
					$author$project$CustomTypes$Films$ClickedSaveFilm(maybeFilmID))
				]),
			_List_fromArray(
				[
					A4($author$project$CustomTypes$Films$viewInput, 'text', $author$project$CustomTypes$Films$InputTitle, 'Title', form.title),
					A4($author$project$CustomTypes$Films$viewInput, 'text', $author$project$CustomTypes$Films$InputTrailer, 'Trailer URL', form.trailer),
					A4($author$project$CustomTypes$Films$viewInput, 'text', $author$project$CustomTypes$Films$InputPoster, 'Poster URL', form.poster),
					A4($author$project$CustomTypes$Films$viewInput, 'text', $author$project$CustomTypes$Films$InputSummary, 'Summary', form.summary),
					A4($author$project$CustomTypes$Films$viewInput, 'text', $author$project$CustomTypes$Films$InputTags, 'Tags (comma separated)', form.tags),
					button
				]));
	});
...
var $author$project$CustomTypes$Films$posterUrl = 'http://localhost:3000/poster/';
...
var $author$project$CustomTypes$Films$viewPoster = function (id) {
	return A2(
		$elm$html$Html$img,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$src(
				_Utils_ap($author$project$CustomTypes$Films$posterUrl, id)),
...
var $author$project$CustomTypes$Films$nameToString = function (_v0) {
	var name = _v0.a;
	return name;
};
var $author$project$CustomTypes$Films$starsToNumber = function (star) {
	switch (star.$) {
		case 'One':
			return 1;
		case 'Two':
...
var $author$project$CustomTypes$Films$viewReview = function (review) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text(
				'Review by ' + $author$project$CustomTypes$Films$nameToString(review.name)),
				$elm$html$Html$text(
				'Rating: ' + $elm$core$String$fromInt(
					$author$project$CustomTypes$Films$starsToNumber(review.rating))),
				$elm$html$Html$text('Review: ' + review.review),
				$elm$html$Html$text(
...
var $author$project$CustomTypes$Films$viewTrailor = function (maybeUrl) {
	if (maybeUrl.$ === 'Just') {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Watch trailer')
				]));
	} else {
		return $elm$html$Html$text('No trailer available');
	}
};
var $author$project$CustomTypes$Films$viewFilm = function (film) {
	...
	function (filmID, review) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					'Add review by ' + $author$project$CustomTypes$Films$nameToString(review.name)),
...
var $author$project$CustomTypes$Films$InputName = function (a) {
	return {$: 'InputName', a: a};
};
var $author$project$CustomTypes$Films$InputRating = function (a) {
	return {$: 'InputRating', a: a};
};
var $author$project$CustomTypes$Films$InputReview = function (a) {
	return {$: 'InputReview', a: a};
};
var $author$project$CustomTypes$Films$viewReviewForm = F3(
	function (filmID, form, button) {
		return A2(
			$elm$html$Html$form,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					A4($author$project$CustomTypes$Films$viewInput, 'text', $author$project$CustomTypes$Films$InputName, 'Name', form.name),
					A4($author$project$CustomTypes$Films$viewInput, 'text', $author$project$CustomTypes$Films$InputReview, 'Review', form.review),
					A4($author$project$CustomTypes$Films$viewInput, 'text', $author$project$CustomTypes$Films$InputRating, 'Rating', form.rating),
					button
				]));
	});
var $author$project$CustomTypes$Films$viewReviewFormOrRandom = F2(
	function (filmID, model) {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					A3($author$project$CustomTypes$Films$viewReviewForm, filmID, model, $author$project$CustomTypes$Films$addReviewButton),
					function () {
					var _v0 = model.apiReview;
					if (_v0.$ === 'Nothing') {
						return A2(
							$elm$html$Html$button,
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick($author$project$CustomTypes$Films$ClickedRandom)
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('Get a random review')
								]));
					} else {
						var review = _v0.a;
						return A2($author$project$CustomTypes$Films$saveAPIReviewButton, filmID, review);
					}
				}()
				]));
	});
var $author$project$CustomTypes$Films$viewFilmOrForm = F3(
	function (formState, model, film) {
		...
		switch (formState.$) {
			...
			case 'EditFilm':
				var selectedFilmID = formState.a;
				return _Utils_eq(selectedFilmID, filmID) ? A3(
					$author$project$CustomTypes$Films$viewFilmForm,
					$elm$core$Maybe$Just(filmID),
					model,
					$author$project$CustomTypes$Films$editFilmButton) : $author$project$CustomTypes$Films$viewFilm(film);
			default:
				var selectedFilmID = formState.a;
				return _Utils_eq(selectedFilmID, filmID) ? A2($author$project$CustomTypes$Films$viewReviewFormOrRandom, filmID, model) : $author$project$CustomTypes$Films$viewFilm(film);
		}
	});
...
var $author$project$CustomTypes$Films$view = function (model) {
	...
	switch (_v0.$) {
		case 'Loading':
			return $elm$html$Html$text('Loading films...');
		case 'LoadingSlowly':
			return $elm$html$Html$text('Loading films slowly...');
		case 'Success':
			var films = _v0.a;
			return A2(
				$elm$html$Html$main_,
		...
		default:
			var errorMsg = _v0.a;
			return $elm$html$Html$text('Error loading films: ' + errorMsg);
	}
};
var $author$project$CustomTypes$Films$main = $elm$browser$Browser$element(
	{init: $author$project$CustomTypes$Films$init, subscriptions: $author$project$CustomTypes$Films$subscriptions, update: $author$project$CustomTypes$Films$update, view: $author$project$CustomTypes$Films$view});
_Platform_export({'CustomTypes':{'Films':{'init':$author$project$CustomTypes$Films$main(
