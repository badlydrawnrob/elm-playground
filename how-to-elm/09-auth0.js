...
var $author$project$Auth$Auth0$ProfileFull = F9(
...
var $author$project$Auth$Auth0$decoderFull = F2(
	function (a, b) {
		return A3(
			...
			A9(
				...
				$author$project$Auth$Auth0$ProfileFull,
				...
				A2($elm$json$Json$Decode$field, 'updated_at', $author$project$Auth$Auth0$decoderDate),
				A2(
...
var $author$project$Auth$Auth$getProfile = A4(
	...
	A2($author$project$Auth$Auth0$decoderFull, $author$project$Auth$Auth$decoderUserMetadata, $author$project$Auth$Auth$decoderAppMetadata));
