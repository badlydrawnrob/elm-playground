...
var $author$project$PhotoFolders$imgSource = F2(
	function (url, size) {
		return $elm$html$Html$Attributes$src($author$project$PhotoFolders$urlPrefix + ('photos/' + (url + size)));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($author$project$PhotoFolders$imgSource, url, '/thumb')
			]),
		_List_Nil);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($author$project$PhotoFolders$imgSource, photo.url, '/full')
					]),
				_List_Nil),
				A2(
				$elm$html$Html$span,
