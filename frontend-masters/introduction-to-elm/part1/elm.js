...
var $author$project$Main$feed = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			$elm$html$Html$text('(In the future we’ll display a feed of articles here!)')
		]));
var $author$project$Main$main = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('👉 TODO: Replace this <div> with the banner')
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
