...
var $author$project$Main$viewFeed = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			$elm$html$Html$text('(We’ll display some articles here later.)')
		]));
...
var $author$project$Main$viewTag = function (tagName) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('tag-pill'),
				$elm$html$Html$Attributes$class('tag-default')
			]),
		_List_fromArray(
			[
...
var $author$project$Main$viewTags = function (tags) {
	var renderedTags = A2($elm$core$List$map, $author$project$Main$viewTag, tags);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
